...
- Create Angular project with ng: `ng new angularwithnetbackend.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`angularwithnetbackend.client.esproj`).
